...
*/
export declare function encodeParams(params: any, funAbi: any, callback?: any): Promise<unknown>;
/**
...
export declare const normalizeParam: (param: any) => any;
export declare const REGEX_SCIENTIFIC: RegExp;
export declare const REGEX_DECIMAL: RegExp;
