...
class BreakpointManager {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            while (currentStep > 0 && currentStep < trace.length) {
                ...
                if (initialLine.start.line !== lineColumn.start.line) {
                    ...
                    if (yield this.hasBreakpointAtLine(sourceLocation.file, lineColumn.start.line, contractAddress)) {
    ...
    /**
      ...
      */
    hasBreakpointAtLine(fileIndex, line, contractAddress) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const compResult = yield this.solidityProxy.compilationResult(contractAddress);
