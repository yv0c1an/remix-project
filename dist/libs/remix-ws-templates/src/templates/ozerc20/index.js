...
exports.default = (opts) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    if (opts) {
        wizard_1.erc20.defaults.mintable = opts.mintable;
        wizard_1.erc20.defaults.burnable = opts.burnable;
        wizard_1.erc20.defaults.pausable = opts.pausable;
    }
    const filesObj = {
        'contracts/MyToken.sol': wizard_1.erc20.print(Object.assign(Object.assign({}, wizard_1.erc20.defaults), { upgradeable: opts && opts.upgradeable ? opts.upgradeable : false })),
        // @ts-ignore
    ...
    if (!opts || opts.upgradeable === undefined || !opts.upgradeable) {
        // @ts-ignore
        if (wizard_1.erc20.defaults.mintable)
